...
export default function MyReports() {
    ...
    return (
        <Layout>
            <h1 className="text-3xl font-bold text-gray-800 mb-6">Meus Reports 📋</h1>
            <p className="text-gray-500 mb-8">Acompanha o estado dos problemas que reportaste.</p>
                        ...
                        <div
                            ...
                            className={`p-6 rounded-2xl border flex flex-col md:flex-row justify-between items-start md:items-center gap-4 transition-all ${
                                report.status === "resolvido"
                                    ...
                                    : "bg-white border-red-100 shadow-sm border-l-4 border-l-red-500"
                            }`}
                        >
